...
f1 = open('test-ner-5571-T5-outputs.txt', 'r', encoding='utf-8')
f2 = open('predict_results_canard.txt', 'r', encoding='utf-8')
f2_ = open('pred_test_05_0.5183.txt', 'r', encoding='utf-8')
f3 = open('test-ner-5571-T5-ids.txt', 'r', encoding='utf-8')
...
def calc_standard_F1(restate_str, predict_str, cur_str, my=False):
    i1c, p1c, r1c = restored_count(restate_str, predict_str, cur_str, my, 1)
    #print(i1c, p1c, r1c)
...
def calc_standard_F2(restate_str, predict_str, cur_str, my=False):
    i1c, p1c, r1c = restored_count(restate_str, predict_str, cur_str, my, 2)
    #print(i1c, p1c, r1c)
    total_i1c, total_p1c, total_r1c = 0, 0, 0
    for x in i1c:
        total_i1c += x
...
while True:
    line = f2_.readline()
    line = line.strip()
    T5_canards.append(clean(line))
    cntl2 += 1
    if cntl2 == 5571:
        break
            
f_mask = open('test-with-mask-ner.txt', 'r')
cnt_mask = 0
mask_utts = []
while True:
...
f4 = open('test-ner-5571-T5-inputs.txt', 'r')
li1_inputs = []
while True:
    line = f4.readline()
    line = line.strip()
...
allhave = 0
ft = open('scorelist-becky-ner-5571.txt', 'w')
...
f_forhuman = open('predict_results_becky-ner.txt', 'w', encoding='utf-8')
for sen in pre2s:
...
print('')
print('baseline_standard_F1:', calc_standard_F1(refs, pres, curs))
#print(pre2s)
print('my_standard_F1:', calc_standard_F1(refs, pre2s, curs))
print('T5_canard_standard_F1:', calc_standard_F1(refs, T5_canards, curs))

print('')
print('baseline_standard_F2:', calc_standard_F2(refs, pres, curs))
#print(pre2s)
print('my_standard_F2:', calc_standard_F2(refs, pre2s, curs))
print('T5_canard_standard_F2:', calc_standard_F2(refs, T5_canards, curs))
...
f3 = open('show-becky-ner-5571-T5.txt', 'w', encoding='utf-8')
for sid in ids:
