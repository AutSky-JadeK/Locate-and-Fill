...
f1 = open('test-forf1-multi-T5-outputs.txt', 'r', encoding='utf-8')
f2 = open('predict_results_canard.txt', 'r', encoding='utf-8')
f3 = open('test-multi-T5-ids.txt', 'r', encoding='utf-8')
...
f4 = open('test-prompt-multi-T5-outputs.txt', 'r')
li1_inputs = []
while True:
    line = f4.readline()
    line = line.strip()
...
f3 = open('show-prompt-multi-T5.txt', 'w', encoding='utf-8')
for sid in ids:
