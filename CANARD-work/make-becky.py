...
f2 = open('dev-prompt-5571-T5.json', 'w', encoding='utf-8')
f3 = open('dev-prompt-5571-T5-ids.txt', 'w', encoding='utf-8')
f4 = open('dev-prompt-5571-T5-inputs.txt', 'w', encoding='utf-8')
f5 = open('dev-multi-T5-inputs.txt', 'w', encoding='utf-8')
f6 = open('dev-bertcrf.txt', 'w', encoding='utf-8')
cnt = 0
