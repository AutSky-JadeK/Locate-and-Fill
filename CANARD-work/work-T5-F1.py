...
f1 = open('test-prompt-5571-T5-outputs.txt', 'r', encoding='utf-8')
f2 = open('predict_results_canard.txt', 'r', encoding='utf-8')
f3 = open('test-prompt-5571-T5-ids.txt', 'r', encoding='utf-8')
...
f4 = open('test-prompt-5571-T5-inputs.txt', 'r')
li1_inputs = []
while True:
    line = f4.readline()
    line = line.strip()
...
allhave = 0
ft = open('scorelist-prompt-5571.txt', 'w')
...
f3 = open('show-prompt-5571-T5.txt', 'w', encoding='utf-8')
for sid in ids:
