...
f1 = open('mudoco_test.txt', 'r', encoding='utf-8')
f2 = open('mudoco_test-prompt-5571-T5-greedy.json', 'w', encoding='utf-8')
f3 = open('mudoco_test-prompt-5571-T5-ids-greedy.txt', 'w', encoding='utf-8')
f4 = open('mudoco_test-prompt-5571-T5-inputs-greedy.txt', 'w', encoding='utf-8')
f5 = open('mudoco_test-multi-T5-inputs-greedy.txt', 'w', encoding='utf-8')
f6 = open('mudoco_test-bertcrf-greedy.txt', 'w', encoding='utf-8')
cnt = 0
