...
f1 = open('alexa_dev.txt', 'r', encoding='utf-8')
f2 = open('alexa_dev-prompt-5571-T5.json', 'w', encoding='utf-8')
f3 = open('alexa_dev-prompt-5571-T5-ids.txt', 'w', encoding='utf-8')
f4 = open('alexa_dev-prompt-5571-T5-inputs.txt', 'w', encoding='utf-8')
f5 = open('alexa_dev-multi-T5-inputs.txt', 'w', encoding='utf-8')
f6 = open('alexa_dev-with-mask.txt', 'w', encoding='utf-8')
cnt = 0
