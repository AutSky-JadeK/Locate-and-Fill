...
class CoNLLDataProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        return self._create_examples(
            self._read_data(os.path.join(data_dir, "alexa_train-becky-bertcrf.txt")))

    def get_dev_examples(self, data_dir):
        return self._create_examples(
            self._read_data(os.path.join(data_dir, "alexa_dev-becky-bertcrf.txt")))

    def get_test_examples(self, data_dir):
        return self._create_examples(
            self._read_data(os.path.join(data_dir, "alexa_test-becky-bertcrf.txt")))
...
fo = open('predicted_ner_labels_alexa_becky.txt', 'w')
