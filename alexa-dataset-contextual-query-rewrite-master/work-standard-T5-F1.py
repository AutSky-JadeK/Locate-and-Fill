...
f1 = open('alexa_test-becky-prompt-5571-T5-outputs.txt', 'r', encoding='utf-8')
f2 = open('alexa_test.txt', 'r', encoding='utf-8')
f2_ = open('pred_dev_21_0.2089.txt', 'r', encoding='utf-8')
f3 = open('alexa_test-becky-prompt-5571-T5-ids.txt', 'r', encoding='utf-8')
...
while True:
    ...
    line = line.strip()
    pts = line.split('\t\t')
    T5_canards.append(clean(pts[-1]))
    cntl2 += 1
    if cntl2 == 214:
        break
            
f_mask = open('alexa_test-with-mask-becky-prompt.txt', 'r')
cnt_mask = 0
mask_utts = []
while True:
...
f4 = open('alexa_test-becky-prompt-5571-T5-inputs.txt', 'r')
li1_inputs = []
while True:
    line = f4.readline()
    line = line.strip()
...
allhave = 0
ft = open('scorelist-becky-prompt-alexa-5571.txt', 'w')
...
f_forhuman = open('predict_results_alexa_becky-prompt.txt', 'w', encoding='utf-8')
for sen in pre2s:
...
f3 = open('show-alexa-becky-prompt-5571-T5.txt', 'w', encoding='utf-8')
for sid in ids:
