...
f1 = open('alexa_test-with-mask-becky-ner.txt', 'r', encoding='utf-8')
f2 = open('alexa_test-becky-ner-5571-T5-inputs.txt', 'w', encoding='utf-8')
f3 = open('alexa_test-becky-ner-5571-T5-ids.txt', 'w', encoding='utf-8')
